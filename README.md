...
- PWA Categories page supports inline category rename/edit (including expense-category reimbursement settings) and reimbursement auto-match rule management (link expense categories to income/transfer categories).
